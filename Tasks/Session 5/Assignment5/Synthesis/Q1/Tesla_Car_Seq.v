...
// Date        : Wed Aug  6 00:57:56 2025
// Host        : DESKTOP-DTNSAHB running 64-bit major release  (build 9200)
// Command     : write_verilog {D:/College Projects/Digital_Course_Waseem/Vv/Q1/Tesla_Car_Seq.v}
// Design      : Tesla_Car
...
module Tesla_Car
  ...
  wire \FSM_sequential_cs_reg[1]_i_3_n_0 ;
  wire \FSM_sequential_cs_reg[1]_i_3_n_1 ;
  wire \FSM_sequential_cs_reg[1]_i_3_n_2 ;
  wire \FSM_sequential_cs_reg[1]_i_3_n_3 ;
  wire accelerate_car;
  ...
  LUT5 #(
    ...
    \FSM_sequential_cs[0]_i_1 
       (.I0(cs[0]),
        .I1(\FSM_sequential_cs_reg[1]_i_3_n_0 ),
  ...
  LUT5 #(
    ...
    \FSM_sequential_cs[1]_i_1 
       (.I0(cs[0]),
        ...
        .I3(\FSM_sequential_cs_reg[1]_i_3_n_0 ),
  ...
  LUT5 #(
    ...
    \FSM_sequential_cs[1]_i_4 
       (.I0(car_speed_IBUF[2]),
        ...
        .I2(car_speed_IBUF[0]),
        .I3(car_speed_IBUF[1]),
        .I4(\FSM_sequential_cs[1]_i_13_n_0 ),
  ...
  (* FSM_ENCODED_STATES = "STOP:00,DECELERATE:10,ACCELERATE:01" *) 
  (* KEEP = "yes" *) 
  FDCE #(
    .INIT(1'b0)) 
  ...
  FDCE #(
    ...
    \FSM_sequential_cs_reg[1] 
       (.C(clk_IBUF_BUFG),
        ...
        .D(ns[1]),
        .Q(cs[1]));
  CARRY4 \FSM_sequential_cs_reg[1]_i_3 
       (.CI(\<const0> ),
        .CO({\FSM_sequential_cs_reg[1]_i_3_n_0 ,\FSM_sequential_cs_reg[1]_i_3_n_1 ,\FSM_sequential_cs_reg[1]_i_3_n_2 ,\FSM_sequential_cs_reg[1]_i_3_n_3 }),
        .CYINIT(\<const0> ),
        .DI({\FSM_sequential_cs[1]_i_5_n_0 ,\FSM_sequential_cs[1]_i_6_n_0 ,\FSM_sequential_cs[1]_i_7_n_0 ,\FSM_sequential_cs[1]_i_8_n_0 }),
        .S({\FSM_sequential_cs[1]_i_9_n_0 ,\FSM_sequential_cs[1]_i_10_n_0 ,\FSM_sequential_cs[1]_i_11_n_0 ,\FSM_sequential_cs[1]_i_12_n_0 }));
  GND GND
       (.G(\<const0> ));
  VCC VCC
       (.P(\<const1> ));
